...
export class UserInfoService {
  user: User = {
    ...
    firstName: 'Mykhailo',
    lastName: 'Papash',
    address: '9/8 Kulchitska Street, Lviv, Ukraine',
    phone: '+380968394646',
    skype: 'Mykhailo Papash (live:9330215576bb18dc)',
    email: 'mishapapash@gmail.com',
    telegram: '@Mykhailo_Papash',
    facebook: 'https://www.facebook.com/www.mishapapash',
    linkedin: 'https://www.linkedIn.com/in/mykhailo-papash-430a601ba'
  };
  ...
  projectArray: Project[] = [
    ...
    {
      projectLogo: '../../assets/logos/1200px-The_Project_logo.svg.png',
